...
function AdminListOeuvres({ navigation }) {
  const { user } = useSelector((state) => state.user_reducer);
  const dispatch = useDispatch();
  const { oeuvres, loading, error,success } = useSelector((state) => state.oeuvre_reducer);
            ...
            <Text style={styles.author}>Auteur: {item.auteur}</Text>
              <View style={styles.buttonContainer}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => navigation.navigate('Admin Modifier Oeuvres', { oeuvre: item })}
                >
...
export default AdminListOeuvres;
